import Container from "../weatherComponents/container";
import ForecastWeatherDetail from "../weatherComponents/ForecastWeatherDetails";
...
import { convertKelvinToCelsius } from "../api/weather";
import { convertWindSpeed } from "../api/weather";
import { getDayOrNightIcon } from "../api/weather";
import { metersToKilometers } from "../api/weather";
import axios from "axios";
import { format, fromUnixTime, parseISO } from "date-fns";
import { useQuery } from "react-query";
import { loadingCityAtom, placeAtom } from "../api/weather";
...
export default function Home() {
  ...
  const { isLoading, error, data, refetch } = useQuery("repoData",
    async () => {
      const { data } = await axios.get('http://localhost:5000/api/v1/users/weather')
